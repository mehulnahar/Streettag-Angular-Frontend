...
export class CancelgiftComponent implements OnInit {
  ...
  public dataSource = new MatTableDataSource<GiftCardElement>([]);
  ...
  deleteLocation(GiftCard_id:any) {
    ...
    this.ajaxService.post(data, url).subscribe((data) => {
      ...
      this.snackBar.open("Gift Card deleted Successfully!", undefined, {
        duration: 3000,
  ...
  getallLocations() {
    ...
    this.ajaxService.get<ApiResponse>(url).subscribe((data) => {
      this.dataSource = new MatTableDataSource<GiftCardElement>(data.response[0]);
      this.dataSource.paginator = this.paginator;
    });
  }
  ////////////////////delete Dialoge///////////////////
