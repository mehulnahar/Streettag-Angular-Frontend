    ...
    dialogRef.afterClosed().subscribe((dialogResult) => {
      if (dialogResult == true) {
        ...
        this.ajaxService.post(dataObj, url).subscribe(
          (data) => {
            this.getBroadcastCategory();
            this.snackBar.open("Category has been Deleted Successfully.", undefined, {
              duration: 3000,
          ...
          (error) => {
              this.snackBar.open("Something went wrong, please try again", undefined, {
                duration: 2000,
                verticalPosition: "top",
...
export class DialogAddBroadcastCategory {
  ...
  addCategory() {
    if (this.imgURL == "" || this.imgURL == null) {
      this.snackBar.open("please upload image.", undefined, {
        duration: 3000,
        verticalPosition: "top",
        panelClass: ["red-snackbar"],
      });
