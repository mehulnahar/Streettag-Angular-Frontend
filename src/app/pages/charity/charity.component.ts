...
export class CharityComponent implements OnInit {
  ...
  public dataSource: MatTableDataSource<CharityData>;
  ...
  constructor(
    ...
    this.dataSource = new MatTableDataSource<CharityData>();
  ...
  getChairtyList() {
    const url = `${this.baseUrl}getCharityList`;
    this.ajaxService.get<ApiResponse>(url).subscribe(
      (data) => {
        this.dataSource = new MatTableDataSource<CharityData>(data.response);
